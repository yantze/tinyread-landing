import { BookOpen, Zap, Eye, ArrowRight, Star, Chrome, Sparkles } from "lucide-react";
    ...
    <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
      <div className="space-y-8">
        <h1 className="font-display text-5xl md:text-6xl leading-tight">
          TinyRead{" "}
          <span className="text-primary inline-block rotate-1">Auto Summary</span>{" "}
          <span className="text-secondary inline-block animate-gentle-bounce">✨</span>
        </h1>
        <p className="text-lg md:text-xl font-body max-w-md">
          AI-powered article summarization injected directly into web pages. Read smarter, not longer.
        </p>
        <div className="flex flex-wrap gap-4">
          <Button size="lg" asChild>
            <a href={CHROME_STORE_URL} target="_blank" rel="noopener noreferrer">
              Get Started <Chrome className="ml-1" strokeWidth={2.5} />
            </a>
          </Button>
        ...
        <div className="border-[3px] border-dashed border-foreground wobbly-alt p-8 bg-card shadow-hard-lg rotate-2 hover:-rotate-1 transition-transform duration-100">
          <div className="aspect-square flex items-center justify-center">
            <div className="text-center space-y-4">
              ...
              <p className="font-body text-muted-foreground">( injected right into the page )</p>
            </div>
          </div>
...
const features = [
  {
    icon: Eye,
    title: "In-Page Injection",
    description: "No more copy-paste! AI summaries are injected directly into the web page you're reading — at the top of the article or in the sidebar.",
  ...
  },
  {
    ...
    description: "Advanced AI models scan and analyze long articles, stripping redundant info to extract core points, key data, and main conclusions.",
  ...
  },
  {
    icon: Zap,
    title: "Auto Trigger",
    description: "Set it and forget it. TinyRead runs automatically when you open an article, providing instant reliable summaries that blend with original content.",
    decoration: "tape" as const,
    rotate: "-rotate-2",
    accent: true,
  },
...
const steps = [
  { num: "1", title: "Install from Chrome Store", desc: "One click to add TinyRead to your browser. No account needed." },
  { num: "2", title: "Open any article", desc: "Navigate to any long article, blog post, or news coverage as usual." },
  { num: "3", title: "Get instant summary", desc: "AI-generated summary appears right inside the page. Read the gist in seconds." },
];
...
const testimonials = [
  { name: "Alex K.", text: "Finally, I don't have to copy-paste articles into ChatGPT. TinyRead just shows the summary right there!", stars: 5 },
  { name: "Mia R.", text: "Game changer for my research workflow. I can skim 10 articles in the time it used to take for 2.", stars: 5 },
];
    ...
    <div className="min-h-screen">
      <nav className="sticky top-0 z-50 bg-background/90 backdrop-blur-sm border-b-2 border-dashed border-foreground px-6 py-4">
        <div className="max-w-5xl mx-auto flex justify-between items-center">
          <span className="font-display text-2xl md:text-3xl">TinyRead 📖</span>
          <div className="flex items-center gap-6">
            <a href="#features" className="hidden md:inline font-body text-lg relative group">
              Features
            ...
            <Button size="sm" asChild>
              <a href={CHROME_STORE_URL} target="_blank" rel="noopener noreferrer">Get Started</a>
            </Button>
          </div>
        </div>
      </nav>
      ...
      <section className="py-20 px-6">
        <div className="max-w-3xl mx-auto text-center border-[3px] border-foreground wobbly-alt bg-accent p-10 md:p-16 shadow-hard-lg rotate-1 hover:rotate-0 transition-transform duration-100">
          <h2 className="font-display text-4xl md:text-5xl mb-6">Ready to read smarter?</h2>
          <p className="font-body text-lg md:text-xl mb-8 max-w-lg mx-auto">
            Install TinyRead and let AI summarize every article for you — right inside the page. Free and instant.
          </p>
          <Button size="lg" asChild>
            <a href={CHROME_STORE_URL} target="_blank" rel="noopener noreferrer">
              Add to Chrome <ArrowRight className="ml-1" strokeWidth={2.5} />
            </a>
          </Button>
        </div>
      </section>
